...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      ...
      <small><?php echo $this->lang->line('stores'); ?></small>
    </h1>
    <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-dashboard"></i> <?php echo $this->lang->line('home'); ?></a></li>
      <li class="active"><?php echo $this->lang->line('stores'); ?></li>
    </ol>
  </section>
      ...
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          <div class="box-header">
            <h3 class="box-title"><?php echo $this->lang->line('manage stores'); ?></h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title"><?php echo $this->lang->line('add store'); ?></h4>
      </div>
      ...
      <form role="form" action="<?php echo base_url('stores/create') ?>" method="post" id="createForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="brand_name"><?php echo $this->lang->line('store name'); ?></label>
    ...
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('stores/update') ?>" method="post" id="updateForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="edit_brand_name"><?php echo $this->lang->line('store name'); ?></label>
