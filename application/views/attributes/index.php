    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <?php //if(in_array('createGroup', $user_permission)): ?>
          <button class="btn btn-primary" data-toggle="modal" data-target="#addModal"><?php echo $this->lang->line('add attribute'); ?></button>
          <br /> <br />
        <?php //endif; ?>

        <div class="box">
          <div class="box-header">
            <h3 class="box-title"><?php echo $this->lang->line('manage attribute'); ?></h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
...
<div class="modal fade" tabindex="-1" role="dialog" id="editModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title"><?php echo $this->lang->line('edit attribute'); ?></h4>
      </div>
      ...
      <form role="form" action="<?php echo base_url('attributes/update') ?>" method="post" id="updateForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="edit_brand_name"><?php echo $this->lang->line('attribute name'); ?></label>
