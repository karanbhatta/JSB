  ...
  <section class="content">
      ...
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Edit Export</h3>
          </div>
          <!-- /.box-header -->
   ...
   <?php if($order_data['order']['vehicle_no'] == $v['v_no']) { echo "selected='selected'"; } ?>
                  ...
                  <!-- <input type="text" name="sid" id="sid" hidden> -->
                   ...
                   <div class="form-group">
                    <label for="gross_amount" class="col-sm-5 control-label" style="text-align:left;"><?php echo $this->lang->line('lot no'); ?></label>
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="lot_no" name="lot_no" placeholder="Enter Lot Number" autocomplete="off" value=" <?php echo $order_data['order']['lot_no'] ?>">
                       <input type="text"  id="bill_no" name="bill_no"  value=" <?php echo $order_data['order']['bill_no'] ?>" hidden>
                    </div>
                  </div> 
