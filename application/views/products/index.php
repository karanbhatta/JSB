    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <?php if(in_array('createProduct', $user_permission)): ?>
          <a href="<?php echo base_url('products/create') ?>" class="btn btn-primary"><?php echo $this->lang->line('add product'); ?></a>
          <br /> <br />
        <?php endif; ?>

        <div class="box">
          <div class="box-header">
            <h3 class="box-title"><?php echo $this->lang->line('manage'); ?> <?php echo $this->lang->line('products'); ?></h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
