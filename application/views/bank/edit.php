          ...
          <form role="form" action="<?php base_url('Bank/create') ?>" method="post" class="form-horizontal">
              <div class="box-body">
                ...
                <div class="col-md-4 col-xs-12 pull pull-left">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="bank_name" name="bank_name" placeholder="Enter Bank Name" value="<?php echo $order_data['order']['bank_name'] ?>" autocomplete="off" />
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="cheque_name" name="cheque_name" value="<?php echo $order_data['order']['ac_name'] ?>" placeholder="Enter A/C holder  name" autocomplete="off">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="account_no" name="account_no" placeholder="Account Number" value="<?php echo $order_data['order']['account_no'] ?>" autocomplete="off">
                    </div>
                  </div>
                ...
                <div class="col-md-4 col-xs-12 pull pull-right">
 				<div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="number" class="form-control" id="amount" name="amount" placeholder="Enter Amount" value="<?php echo $order_data['order']['amount'] ?>" autocomplete="off" />
                    </div>
                  </div>
              ...
              <div class="box-footer">
                ...
                <a target="__blank" href="<?php echo base_url() . 'Bank/printDiv/'.$order_data['order']['id'] ?>" class="btn btn-default" >Print</a>
                <button type="submit" class="btn btn-primary">Save Changes</button>
                <a href="<?php echo base_url('Bank/') ?>" class="btn btn-warning">Back</a>
              </div>
            </form>
          <!-- /.box-body -->
        </div>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    $("#mainBankNav").addClass('active');
    $("#manageBankNav").addClass('active');
