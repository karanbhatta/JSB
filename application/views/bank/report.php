...
<h3>Bank Transaction Statements</h3>
EOD;
$title.=date('Y');
...
$table .='<tr>
		...
		<th style="border:1px solid #000;">Account Holder</th>
		...
		<th style="border:1px solid #000;">Deposited/Withdrawn By</th>
...
$table .='<tr>
		...
		<td style="border:1px solid #000;">'.$row['bank_name'].'</td>
		<td style="border:1px solid #000;">'.$row['ac_name'].'</td>
		<td style="border:1px solid #000;">'.$row['account_no'].'</td>
		<td style="border:1px solid #000;">'.$row['cheque_no'].'</td>
		<td style="border:1px solid #000;">'.$row['amount'].'</td>
		<td style="border:1px solid #000;">'.$s.'</td>
		<td style="border:1px solid #000;">'.$row['deposited_by'].'</td>
...
$table2 .='
		<td style="border:1px solid #000;">NRs. '.$row['amountt'].'</td>
