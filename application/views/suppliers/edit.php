      ...
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Edit Import</h3>
          </div>
          <!-- /.box-header -->
          <form role="form" action="<?php base_url('suppliers/create') ?>" method="post" class="form-horizontal">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="time" class="col-sm-12 control-label">Date: <?php date_default_timezone_set("Asia/Katmandu"); echo date('h:i a') ?></label>
                </div>
                ...
                <div class="col-md-4 col-xs-12 pull pull-left">
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="bill_no" name="bill_no" placeholder="Enter Bill No." value="<?php echo $order_data['order']['bill_no'] ?>" required="required" autocomplete="off" />
                    </div>
                  </div>
                   <div class="form-group">
                  <label for="brands"><?php echo $this->lang->line('supplier name'); ?></label>
                  <select class="form-control select_group" id="supplier_name" name="supplier_name" >
    ...
    $('#sid').val(x);
                ...
                <span><?php echo $this->lang->line('cheque'); ?></span>
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="bank_name" value="<?php echo $order_data['order']['bank_name'] ?>" name="bank_name" placeholder="Enter Bank Name" autocomplete="off" />
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="cheque_no" name="cheque_no" placeholder="Enter Cheque Number" value="<?php echo $order_data['order']['cheque_no'] ?>" autocomplete="off">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="cheque_name" name="cheque_name" value="<?php echo $order_data['order']['cheque_name'] ?>" placeholder="Enter A/C holder  name" autocomplete="off">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="deposited_by" name="deposited_by" value="<?php echo $order_data['order']['deposited_by'] ?>" placeholder="Deposited By" autocomplete="off">
                    </div>
                  </div>
                </div>
                <!--  -->
                ...
                <div class="col-md-6 col-xs-12 pull pull-right">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="service_charge" name="service_charge"  value="<?php echo $order_data['order']['service_charge'] ?>" autocomplete="off" onkeyup="subAmount()" >
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="vat_charge" name="vat_charge"  value="<?php echo $order_data['order']['vat_charge'] ?>" autocomplete="off" onkeyup="subAmount()" >
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="paid_amount" name="paid_amount" placeholder="Paid Amount" onkeyup="getPaidAmount()" value="<?php echo $order_data['order']['paid_amount'] ?>" autocomplete="off">
                    </div>
                  </div>

                  <div class="form-group">
                    <label for="net_amount" class="col-sm-5 control-label">Due Amount</label>
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="due_amount" name="due_amount" disabled value="<?php echo $order_data['order']['due_amount'] ?>" autocomplete="off">
                      <input type="hidden" class="form-control" id="due_amount_value" name="due_amount_value" value="<?php echo $order_data['order']['due_amount'] ?>" autocomplete="off">
                    </div>
                  </div>
              ...
              <div class="box-footer">
                ...
                <a target="__blank" href="<?php echo base_url() . 'suppliers/printDiv/'.$order_data['order']['id'] ?>" class="btn btn-default" >Print</a>
