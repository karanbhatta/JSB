  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <?php echo $this->lang->line('supplier ledger'); ?>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> <?php echo $this->lang->line('home'); ?></a></li>
        <li class="active"><?php echo $this->lang->line('supplier ledger'); ?></li>
      </ol>
    </section> 
    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <div class="col-md-12 col-xs-12"> 
             <form role="form" action="<?php echo base_url('Suppliers/getSupplierLedgerDetail') ?>" id="removeBrandForm">
...
<select class="form-control select_group product" data-row-id="row_1" id="customer_name" name="customer_name" style="width:100%;" required>
                            ...
                            <?php foreach ($customer_data as $k => $v): ?>
                              ...
                              <small>, Address: <?php echo $v['address'] ?></small><small>, Phone: <?php echo $v['contact'] ?></small></option>
