    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <?php if(in_array('createEmployee', $user_permission)): ?>
          <a href="<?php echo base_url('employees/createSalary') ?>" class="btn btn-primary"><?php echo $this->lang->line('add salary'); ?></a>
          <br /> <br />
        <?php endif; ?>

        <div class="box">
          <div class="box-header">
            <h3 class="box-title"><?php echo $this->lang->line('manage salary'); ?></h3>
            <form action="<?php echo base_url('employees/manageSalary') ?>" method="post">
              <div class="row">
              <div class="form-group col-md-4">
                  <select class="form-control select_group" id="emp_id" name="emp_id"  onchange="myFunction()">
                    <option value="">Choose Employee</option>
                    <?php foreach ($employee as $k => $v): ?>
                      <option value="<?php echo $v['id'] ?>" id="<?php echo $v['id'] ?>"><?php echo $v['name'] ?>
                     </option>
                    <?php endforeach ?>
...
<div class="modal fade" tabindex="-1" role="dialog" id="removeModal">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('employees/removeSalary') ?>" method="post" id="removeForm">
...
$(document).ready(function() {
  ...
  $("#manageSalaryNav").addClass('active');

  // initialize the datatable 
  manageTable = $('#manageTable').DataTable({
    'ajax': base_url + 'employees/fetchSalaryData',
    'order': []
  });
