...
<div class="content-wrapper">
    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          ...
          <!-- /.box-header -->
          <form role="form" action="<?php base_url('employees/createSalary') ?>" method="post" class="form-horizontal">
              <div class="box-body">
                ...
                <div class="col-md-4 col-xs-12 pull pull-left">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="number" class="form-control" id="salary" name="salary" placeholder="Enter Salary Amount" autocomplete="off">
                    </div>
                  </div> 
                    <div class="form-group">
                    <label for="gross_amount" class="col-sm-5 control-label" style="text-align:left;"><?php echo $this->lang->line('bonus'); ?></label>
                    <div class="col-sm-7">
                      <input type="number" class="form-control" id="bonus" name="bonus" placeholder="Enter Bonus Amount" autocomplete="off">
                    </div>
                  </div> 

 <div class="form-group">
  <label for="from_date">From Date:</label>
  <input type="date" data-date-format="d-m-Y" id="from_date" name="from_date" required="required">
 ...
 <div class="form-group">
  ...
  <input type="date" id="to_date" name="to_date" required="required">
