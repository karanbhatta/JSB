...
<div class="card" style="padding: 20px;">
 ...
 <div class="row">
        <div class="col-sm-12 col-md-12">
                ...
                <div class="card-body">
 <form action="<?php base_url('employees/create') ?>" enctype="multipart/form-data" method="post" accept-charset="utf-8">
<div class="tab-content">
                  ...
                  <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input name="name" class="form-control" type="text" placeholder="Full Name" id="name"  required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input name="phone" class="form-control" type="number" placeholder="Phone" id="phone"  required>
                            </div>
                        </div>
                         <div class="form-group row">
                    ...
                    <input type="text" class="form-control" id="post" name="post" placeholder="Post" required>
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input name="alternative_phone" class="form-control" type="number" placeholder="Alternative Phone" id="alternative_phone">
                            </div>
                        </div>
                         <div class="form-group row">
                            <label for="employee_id_no" class="col-sm-3 col-form-label">Employee Id </label>
                            <div class="col-sm-9">
                                <input name="employee_id_no" class="form-control" type="number" placeholder="Employee Id" id="employee_id_no">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="present_address" class="col-sm-3 col-form-label">Present Address </label>
                            <div class="col-sm-9">
                                <textarea name="present_address" class="form-control"  placeholder="Present Address" id="present_address" ></textarea required>
                            </div>
                        </div> 
                        <div class="form-group row">
                            <label for="parmanent_address" class="col-sm-3 col-form-label">Permanent Address </label>
                            <div class="col-sm-9">
                                <textarea name="permanent_address" class="form-control"  placeholder="Permanent Address" id="permanent_address" ></textarea required>
                            </div>
                        </div> 
                         <div class="form-group row">
                      ...
                      <div class="file-loading">
                          <input id="picture" name="picture" type="file">
                           ...
                           <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="date" name="hire_date" class="form-control"  placeholder="Hired Date" id="hire_date" >
                            </div>
                        </div> 
