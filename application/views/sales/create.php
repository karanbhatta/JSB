                ...
                <div class="col-md-4 col-xs-12 pull pull-left">
                  ...
                  <select  class="form-control select_group" id="customer_id" name="customer_id"  onchange="myFunction()">
                    <?php foreach ($customer as $k => $v): ?>
                      <option value="<?php echo $v['id'] ?>" id="<?php echo $v['id'] ?>"><?php echo $v['customer_name'] ?>
                     </option>
...
<!-- due -->
              ...
              <div class="box-footer">
                ...
                <button type="submit" class="btn btn-primary"><?php echo $this->lang->line('create sale entry'); ?></button>
