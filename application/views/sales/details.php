...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><?php echo $this->lang->line('sales'); ?></li> <li class="active"><?php echo $this->lang->line('vehicle'); ?></li>
    </ol>
  </section>
          ...
          <div class="box-body">
            <table id="manageTable" class="table table-bordered table-striped">
              ...
              <tr>
                ...
                <th><?php echo $this->lang->line('customer email'); ?></th>
...
$(document).ready(function() {
  ...
  manageTable = $('#manageTable').DataTable({
    ...
    'ajax': base_url + 'sales/fetchOrdersDataDetail',
     'data': 'post_id=' + id,
    'order': []
  });
