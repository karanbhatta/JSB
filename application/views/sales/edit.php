          ...
          <form role="form" action="<?php base_url('Sales/update') ?>" method="post" class="form-horizontal">
              <div class="box-body">
                ...
                <div class="col-md-4 col-xs-12 pull pull-left">
                   ...
                   <div class="form-group">
                  <label for="brands"><?php echo $this->lang->line('vehicle number'); ?></label>
                  <select class="form-control select_group" id="vehicle_no" name="vehicle_no"  onchange="myFunction()">
                    <?php foreach ($vehicle as $k => $v): ?>
                      <option value="<?php echo $v['v_no'] ?>"


   <?php if($order_data['order']['vehicle_no'] == $v['v_no']) { echo "selected='selected'"; } ?>

                       id="<?php echo $v['v_no'] ?>"><?php echo $v['v_no'] ?>-<?php echo $v['d_name'] ?>
                     </option>
                    <?php endforeach ?>
                  ...
                  <div class="form-group">
                  <label for="brands"><?php echo $this->lang->line('customer name'); ?></label>
                  <select class="form-control select_group" id="customer_id" name="customer_id"  onchange="myFunction()">
                    <?php foreach ($customer as $k => $v): ?>
                      <option value="<?php echo $v['id'] ?>"

  <?php if($order_data['order']['customer_id'] == $v['id']) { echo "selected='selected'"; } ?>
                       id="<?php echo $v['id'] ?>"><?php echo $v['customer_name'] ?>
                     </option>
...
<!-- cheque payment -->
                ...
                <span><?php echo $this->lang->line('cheque'); ?></span>
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="bank_name" name="bank_name" placeholder="Enter Bank Name" autocomplete="off" value=" <?php echo $order_data['order']['bank_name'] ?>" />
                    </div>
                  </div>
                ...
                <div class="col-md-6 col-xs-12 pull pull-right">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      ...
                      <input type="hidden" value="<?php echo $order_data['order']['gross_amount'] ?>"  class="form-control" id="gross_amount_value" name="gross_amount_value" autocomplete="off">
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      ...
                      <input type="hidden" class="form-control" value="<?php echo $order_data['order']['net_amount'] ?>"  id="net_amount_value" name="net_amount_value" autocomplete="off">
                    </div>
                  </div>
...
<!-- due -->
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      ...
                      <input value="<?php echo $order_data['order']['due_amount'] ?>"  type="hidden" class="form-control" id="due_amount_value" name="due_amount_value" autocomplete="off">
                    </div>
                  </div>
