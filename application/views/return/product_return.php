...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      ...
      <small><?php echo $this->lang->line('product return'); ?></small>
    </h1>
    <ol class="breadcrumb">
      <li><a href="#"><i class="fa fa-dashboard"></i> <?php echo $this->lang->line('home'); ?></a></li>
      <li class="active"><?php echo $this->lang->line('return'); ?></li>
    </ol>
  </section>
      ...
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          <div class="box-header">
            <h3 class="box-title"><?php echo $this->lang->line('add product return'); ?></h3>
          </div>
          <!-- /.box-header -->
          <form role="form" action="<?php base_url('ReturnProduct/createReturn') ?>" method="post" class="form-horizontal">
              <div class="box-body">
                ...
                <div class="col-md-4 col-xs-12 pull pull-left">
                  ...
                  <select class="form-control select_group" id="vehicle_no" name="vehicle_no"  onchange="myFunction()">
                    <?php foreach ($vehicle as $k => $v): ?>
                      <option value="<?php echo $v['vehicle_no'] ?>" id="<?php echo $v['vehicle_no'] ?>"><?php echo $v['vehicle_no'] ?>
                     </option>
                    <?php endforeach ?>
                ...
                <div class="form-group">
                  <label for="brands"><?php echo $this->lang->line('date'); ?></label>
                  <select class="form-control select_group" id="date_time" name="date_time"  onchange="myFunction()">
                    <?php foreach ($vehicle as $k => $v): ?>
                      <option value="<?php echo date('d-m-Y',$v['date_time']) ?>" id="<?php echo date('d-m-Y',$v['date_time']) ?>"><?php echo date('d-m-Y',$v['date_time']) ?>
                     </option>
                    <?php endforeach ?>
...
<!-- due -->
 ...
 -->
              ...
              <div class="box-footer">
                ...
                <button type="submit" class="btn btn-primary"><?php echo $this->lang->line('create export'); ?></button>
                <a href="<?php echo base_url('ReturnProduct/') ?>" class="btn btn-warning"><?php echo $this->lang->line('back'); ?></a>
              </div>
            </form>
          <!-- /.box-body -->
        </div>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    $("#mainReturnNav").addClass('active');
    $("#addReturnNav").addClass('active');
