...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
      ...
      <small><?php echo $this->lang->line('waste return'); ?></small>
    </h1>
    <ol class="breadcrumb">
      ...
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          <div class="box-header">
            <h3 class="box-title"><?php echo $this->lang->line('add waste return'); ?></h3>
          </div>
          <!-- /.box-header -->
          <form role="form" action="<?php base_url('ReturnProduct/create') ?>" method="post" class="form-horizontal">
              <div class="box-body">
